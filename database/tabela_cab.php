...
function display_tabela_cab_not()
{
echo "<div id=\"tabela\">";
/*cabecalho da tabela */
    echo "<table border=1>";
...
/*linhas da tabela*/
      ...
      $num_linhas = sizeof(get_cabi_not_apr());
      $c=get_cabi_not_apr();
      $p = 0;
      ...
      while ($p < $num_linhas) {
        ...
        echo "<tr>";
		 echo "<td><a href=gerir_cab_sa.php?cab_id=".$c[$p]['cab_id'].">".$c[$p]['cab_id']."</a></td><td>".$c[$p]['cab_valorpedido']."</td><td>".$c[$p]['cab_descricao_resposta']."</td><td>".$c[$p]['cab_resposta']."</td><td>".$c[$p]['cab_requerimento']."</td><td>".$c[$p]['cab_criado_por']."</td><td>".$c[$p]['cab_apreciado_por']."</td><td>";
        echo "</tr>";
